...
public final class GithubReleaseNoteCollector {
    ...
    private static final String GITHUB_PULL_REQUEST_URL = "https://github.com/apache/shardingsphere/pulls?page=%s&q=is:pr milestone:%s author:%s";
    ...
    private static final String AUTHOR = "strongduanmu";
